...
This branch has minimal code to export data (e.g. observations, actions, RNN hidden states, etc) from Isaac Gym. Next, modify the viewer for third-person follower (render() is causing issues, need to debug).
